      ...
      */
	   public function __construct()
	   {
		...
		public function wc_scm_product_sold_count() {
			...
			echo '<div class="wc-scm"><div class="wc-scm-inner">' . sprintf( __( '<span class="wc-scm-count">%s</span> <span class="wc-scm-text">%s</span>', 'woocommerce' ), $units_sold,$salesTxt ) . '</div></div>';
	    }
	   /** counter css */
...
add_filter( 'woocommerce_get_price_html', 'scm_change_product_price_display' );
add_filter( 'woocommerce_cart_item_price', 'scm_change_product_price_display' );
function scm_change_product_price_display( $price ) {
